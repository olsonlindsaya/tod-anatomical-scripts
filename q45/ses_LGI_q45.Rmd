...
#LGI_data_q3$BilingualCoded <-unclass(LGI_data_q3$BilingualCoded)
...
## INR Models
# run n regressions
my_lms <- lapply(1:n, function(x) lm(outcomes[,x] ~ LGI_data_q3$INR + LGI_data_q3$TBV +LGI_data_q3$V1.Age + LGI_data_q3$BilingualCoded))# change the predictors manually
...
* Income to needs ratio predicts lh transverse temporal and superior temporal LGI, controlling for age and TBV in the Q>=3 dataset (no significant dx by INR interaction), and right hemisphere pars opercularis LGI, controlling for TBV, age, and bilingualism.
...
## SES1 Models
# run n regressions
my_lms <- lapply(1:n, function(x) lm(outcomes[,x] ~ LGI_data_q3$SES1 + LGI_data_q3$TBV + LGI_data_q3$V1.Age + LGI_data_q3$BilingualCoded)) # change the predictors manually
...
## SES1 Models
# run n regressions
my_lms <- lapply(1:n, function(x) lm(outcomes[,x] ~ LGI_data_q3$MEL_cat + LGI_data_q3$TBV + LGI_data_q3$V1.Age + LGI_data_q3$BilingualCoded)) # change the predictors manually
...
## SES1 Models
# run n regressions
my_lms <- lapply(1:n, function(x) lm(outcomes[,x] ~ LGI_data_q3$dxCoded + LGI_data_q3$TBV + LGI_data_q3$V1.Age +LGI_data_q3$sexCoded + LGI_data_q3$BilingualCoded)) # change the predictors manually
...
+ Diagnosis **associated with lh pars opercularis LGI** when controlling for TBV, age, sex/gender, and bilingualism. 
...
### Bilingualism Results Q>=3




```{r, Bilingual Models Q3, echo=FALSE, include=FALSE, eval=FALSE, results= 'asis'}
set.seed(1)
...
## SES1 Models
# run n regressions
my_lms <- lapply(1:n, function(x) lm(outcomes[,x] ~ LGI_data_q3$BilingualCoded + LGI_data_q3$TBV + LGI_data_q3$V1.Age +LGI_data_q3$dxCoded)) # change the predictors manually
...
## SES1 Models
# run n regressions
my_lms <- lapply(1:n, function(x) lm(outcomes[,x] ~ LGI_data_q3$dxCoded + LGI_data_q3$RecLang_T + LGI_data_q3$TBV)) # change the predictors manually
...
## INR Models
# run n regressions
my_lms <- lapply(1:n, function(x) lm(outcomes[,x] ~ CT_data_q3$INR +CT_data_q3$V1.Age + CT_data_q3$sexCoded + CT_data_q3$BilingualCoded)) # change the predictors manually
...
## SES1 Models
# run n regressions
my_lms <- lapply(1:n, function(x) lm(outcomes[,x] ~ CT_data_q3$SES1 + CT_data_q3$sexCoded +CT_data_q3$V1.Age +CT_data_q3$BilingualCoded)) # change the predictors manually
...
## MEL Models
# run n regressions
my_lms <- lapply(1:n, function(x) lm(outcomes[,x] ~ CT_data_q3$MEL_cat + CT_data_q3$sexCoded +CT_data_q3$V1.Age +CT_data_q3$BilingualCoded)) # change the predictors manually
...
## MEL Models
# run n regressions
my_lms <- lapply(1:n, function(x) lm(outcomes[,x] ~ CT_data_q3$dxCoded + CT_data_q3$sexCoded +CT_data_q3$V1.Age +CT_data_q3$BilingualCoded)) # change the predictors manually
...
## MEL Models
# run n regressions
my_lms <- lapply(1:n, function(x) lm(outcomes[,x] ~ SA_data_q3$INR + SA_data_q3$sexCoded +SA_data_q3$V1.Age +SA_data_q3$TBV +SA_data_q3$Bilingual_Coded)) # change the predictors manually
...
## MEL Models
# run n regressions
my_lms <- lapply(1:n, function(x) lm(outcomes[,x] ~ SA_data_q3$SES1 + SA_data_q3$V1.Age + SA_data_q3$TBV + SA_data_q3$Bilingual_Coded)) # change the predictors manually
...
+ Neighborhood advantage associated with **left hemisphere pars orbitalis SA, as in the Q>=4 dataset,** not significantly associated with  pars opercularis SA in this dataset. 

+ Neighborhood advantage is also associated with *as well as* **right hemisphere pars triangularis SA** (not significant in the Q>=4 dataset
...
+ Zip-Income is **not associated** with rh pars triangularis SA in the Q>=3 dataset. 
